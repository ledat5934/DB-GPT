...
(e.g. "Explore the data source structure",
"Load data and perform initial analysis", "Run data-cleaning scripts",
...
Phase: Analyze the sales data structure and source
...
Phase: Load data and perform initial analysis
Action: load_data
